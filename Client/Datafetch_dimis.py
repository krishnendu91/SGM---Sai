...
if(id_node ==2 or 3 or 4 or 5 or 6 or 8 or 10 or 11 or 13):
	...
	algorithm.poweroutage(value_GM['v1'],value_GM['v2'],value_GM['v3'],meterType,id_node,ip_wlan0)
	...
	algorithm.poweroutage(value_LM1['v1'],value_LM1['v2'],value_LM1['v3'],meterType,id_node,ip_wlan0)
	...
	algorithm.poweroutage(value_LM2['v1'],value_LM2['v2'],value_LM2['v3'],meterType,id_node,ip_wlan0)
