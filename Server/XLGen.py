...
while a<13:
  ...
  cur.execute('SELECT timestamp,VLL ,A, PF, F, W, WH  FROM STPHourData where meterName = %(meterName)s and timestamp >= DATE_SUB(NOW(),INTERVAL 1 DAY) order by ID desc;',{'meterName':meterName})
