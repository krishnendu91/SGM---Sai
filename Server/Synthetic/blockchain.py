...
data={"pg1":pg1, "pe1":pe1, "pc1":pc1, "pb1":pb1,"tp1":tp1, "pg2":pg2, "pe2":pe2, "pc2":pc2, "pb2":pb2,"tp2":tp2, "pg3":pg3, "pe3":pe3, "pc3":pc3, "pb3":pb3,"tp3":tp3, "pg2":pg4, "pe2":pe4, "pc2":pc4, "pb2":pb4,"tp2":tp4, "pg5":pg5, "pe5":pe5, "pc5":pc5, "pb5":pb5,"tp5":tp5, "c1":c1,"c2":c2,"c3":c3,"Tconsumption":Tconsumption,"Tgeneration":Tgeneration,"pbal":pbal, "tp1":tp1, "tp2":tp2,"tp3":tp3,"tp4":tp4, "tp5":tp5,"Tc1":Tc1,"Tc2":Tc2,"Tc3":Tc3,"NTp":NTp,"NTc":NTc,"CostBal":CostBal }
print(data)

cur.execute("INSERT INTO `synt-bc` (`Tconsumption`, `Tgeneration`, `pe1`, `pe2`, `pe3`, `pe4`, `pe5`, `c1`, `c2`, `c3`, `pbal`,`tp1`, `tp2`, `tp3`, `tp4`, `tp5`, `Tc1`, `Tc2`, `Tc3`, `NTp`, `NTc`, `CostBal`, pg1, pg2, pg3, pg4, pg5, pc1, pc2, pc3, pc4, pc5, pb1, pb2, pb3, pb4, pb5) VALUES (%(Tconsumption)s, %(Tgeneration)s, %(pe1)s, %(pe2)s, %(pe3)s, %(pe4)s, %(pe5)s, %(c1)s, %(c2)s, %(c3)s, %(pbal)s,%(tp1)s, %(tp2)s, %(tp3)s, %(tp4)s, %(tp5)s, %(Tc1)s, %(Tc2)s,%(Tc3)s, %(NTp)s, %(NTc)s, %(CostBal)s, %(pg1)s, %(pg2)s, %(pg3)s, %(pg4)s, %(pg5)s, %(pc1)s, %(pc2)s, %(pc3)s, %(pc4)s, %(pc5)s, %(pb1)s, %(pb2)s, %(pb3)s, %(pb4)s, %(pb5)s);",data)
conn.commit()
conn.close()
